    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="home.html"><h1><span class="clr-red">Smart</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>The Pillai HOC Campus is one of the Asia’s largest Educational Campuses situated in the catchment area of upcoming Mumbai International Airport and in the heart of the largest industrial belt in Rasayani. It has one and a half million square feet constructed area on 14 acres of sprawling lush greenery. The Canteen for almost 100 students at a time.</p>
                        <ul class="py-1">
                    ...
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91 7021838704</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>agrawaladi555@gmail.com</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Pillai Hoc College, Rasayni</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Khushboo Verma</a></div>
                </main>
            </section>
        `;
        })
