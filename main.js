        ...
        if (event.target.classList.contains('remove-item')){
            ...
            addItem.forEach(item => {
                if (item.FoodID === id){ 
                    ...
                    if ( window.location != 'https://smartcanteen-khushboo.netlify.app/user-orders.html'){
...
function ClientDataFlow(addToCartBtn){
    ...
    firebase.auth().onAuthStateChanged((user) => {
        if (user) {
            ...
            checkOutBtn.addEventListener('click', ()=>{
                ...
                if (addItem.length != 0){
                    ...
                    window.setTimeout(function(){
                        window.location.replace('https://smartcanteen-khushboo.netlify.app/user-orders.html')
                    }, 2600)
                } else {
                    Swal.fire({
                        icon: 'error',
            ...
            // Shows Orders
            if (window.location.href === 'https://smartcanteen-khushboo.netlify.app/user-orders.html'){
